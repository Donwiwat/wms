...
const navigation = [
  ...
  { name: 'Stock Operations', href: '/stock-operations', icon: ArrowRightLeftIcon },
  { name: 'Stock Movements', href: '/stock-movements', icon: SettingsIcon },
]
      ...
      <div className={`fixed inset-0 z-50 lg:hidden ${sidebarOpen ? 'block' : 'hidden'}`}>
        ...
        <div className="fixed inset-y-0 left-0 flex w-64 flex-col bg-white">
          <div className="flex h-16 items-center justify-between px-4">
            <h1 className="text-xl font-semibold text-gray-900">WMS</h1>
            <button
        ...
        <div className="sticky top-0 z-40 flex h-16 bg-white shadow-sm lg:hidden">
          ...
          <div className="flex flex-1 justify-between px-4">
            <div className="flex flex-1">
              <h1 className="text-xl font-semibold text-gray-900 self-center">WMS</h1>
            </div>
            <div className="flex items-center">
